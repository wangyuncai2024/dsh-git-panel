...
import {
  ...
  currentBranchName, duplicateRemotes, emptyState, gitMissingMessage, isSafeRemoteRef,
  localBranchNameFor, notRepoNotice, parseBranchLine, parseBranchOutput, parseCompareOutput,
  parseLsRemoteHead, parseRemoteBranchOutput, parseRemotes, parseStashList, readState, remoteOpFor,
  repoPageUrl, runGit,
} from './git.js'
...
export {
  ...
  // 「本地名 ≠ 上游名」三条路 + 「未合并删不掉」一条路 + 分支名撞远端名的判定
  mismatchPushChoices, forceDeleteChoice, branchNameRemoteConflict, upstreamBranchName,
