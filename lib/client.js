...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const S = {
      ...
      /** 帮助窗口：独立于主面板的可移动小窗（拖标题栏移动）。 */
      helpwin: {
        position: 'fixed', width: '480px', maxWidth: 'calc(100vw - 24px)', maxHeight: '72vh',
      ...
      helpwinBody: { padding: '10px', display: 'flex', flexDirection: 'column', gap: '6px', overflowY: 'auto' },
      ...
      if (showHelp === true) {
        const helpChildren = [
          h('div', {
            ...
            h('span', null, '📖 Git 帮助'),
            h('span', { style: S.helpwinDrag }, '拖标题栏可移动'),
        ...
        helpWindow = h('div', {
          style: Object.assign({}, S.helpwin, { left: helpPos.x + 'px', top: helpPos.y + 'px' }),
          key: 'helpwin',
        }, helpChildren)
      }
