...
import {
  classifyNetworkFailure, classifyPullFailure, classifyPushFailure, mirrorFallbackWorthwhile,
...
import {
  ...
  notRepoNotice, parseBranchLine, parseBranchOutput, parseCompareOutput, parseRemoteBranchOutput,
  parseRemotes, readState, remoteOpFor, runGit,
} from './git.js'
...
import {
  MIRROR_CANDIDATES, NETWORK_OPS, PROBE_URL, mirrorLabel, netConfigPath, netConfigView,
  networkExtraArgs, normalizeNetConfig, probeJobs, probeNetwork, readNetConfig,
...
import {
  ...
  formatGitResult, mergeAbortChoice, opResponse, opTimeoutMs, pickRemoteDefaultBranch,
  recoverPull, recoverPush,
  requiredText, toolArgv, unrelatedChoices,
} from './ops.js'
import { createRoutes, netPatch } from './routes.js'
...
export {
  // 纯解析与决策（git.js）
  parseBranchLine, parseRemotes, remoteOpFor, cloneTargetName, parseBranchOutput,
  parseRemoteBranchOutput, isSafeRemoteRef, parseCompareOutput, pickRemoteDefaultBranch,
  ...
  formatGitResult, requiredText, recoverPush, recoverPull, abortMerge, adoptRemote,
  ...
  MIRROR_CANDIDATES, PROBE_URL, NETWORK_OPS,
