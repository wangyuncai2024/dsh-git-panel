...
function createRoutes(getDefaultDir) {
  ...
  return [stateRoute, opRoute, diagRoute, helpRoute]
}
...
export { parseBranchLine, parseRemotes, classifyPushFailure, pushHint, remoteOpFor, cloneTargetName, normalizeDir, parseBranchOutput, truncateText, renderHelpHtml, escapeHtml }
